...
export interface IStorage {
  ...
  createProductsFromCsv(products: ProductFromCsv[], storeId: number): Promise<Product[]>;
...
export class MemStorage implements IStorage {
  ...
  async createProductsFromCsv(products: ProductFromCsv[], storeId: number): Promise<Product[]> {
