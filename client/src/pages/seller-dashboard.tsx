            ...
            <form id="create-store-form" onSubmit={onSubmitStore}>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="name" name="name" placeholder="Enter your store name" required />
                </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex items-center text-muted-foreground">
            <ShoppingBag className="mr-2 h-4 w-4" />
            <span>Managing {store?.name} (Store ID: {store?.store_id})</span>
          </div>
        </div>
        ...
        <Tabs defaultValue="products">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center">
                    ...
                    <div className="text-2xl font-bold">
                      {products?.reduce((sum, product) => sum + product.stock, 0) || 0} items
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="products" className="space-y-4">
            ...
            {isLoadingProducts ? (
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-muted-foreground text-center mt-1 mb-4">
                    Start adding products or use the CSV upload feature to quickly add multiple products
                  </p>
                  <div className="flex gap-4">
                    ...
                    <Button variant="outline" onClick={() => document.getElementById('csv-upload-tab')?.click()}>
              ...
              <div className="rounded-md border">
                <Table>
                  <TableCaption>Total of {products?.length} products</TableCaption>
                  <TableHeader>
                    <TableRow>
          ...
          {/* CSV Upload Tab */}
          <TabsContent id="csv-upload-tab" value="csv-upload" className="space-y-4">
            <Card>
              <CardHeader>
            ...
            <Card>
              ...
              <CardContent>
                <pre className="p-4 bg-muted rounded-md overflow-x-auto text-xs">
                  name,description,price,category,sku,stock,image<br />
                  Wireless Mouse,High-quality wireless mouse suitable for daily use.,155.57,Accessories,MS-001,41,https://example.com/images/wireless_mouse.jpg<br />
                  Bluetooth Headphones,Premium sound quality with noise cancelling.,250.38,Electronics,BH-002,44,https://example.com/images/bluetooth_headphones.jpg<br />
                  Laptop Stand,Adjustable height and angle for better ergonomics.,427.21,Office Supplies,LS-003,34,https://example.com/images/laptop_stand.jpg
                </pre>
              </CardContent>
            </Card>
          </TabsContent>
